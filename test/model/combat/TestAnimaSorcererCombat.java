...
public class TestAnimaSorcererCombat extends AbstractTestUnit {
    ...
    public void testAttackHeroUnequipped() {
        ...
        testAttackUnequipped(heroTarget, 50, 50 - anima.getPower());
    }

    @Test
    public void testAttackHero() {
        Hero heroTarget = new Hero(50, 2, field.getCell(0, 2));
        testAttackEquipped(heroTarget, 50, (int) (50 - anima.getPower() * 1.5), spear);
    }
    ...
    public void testAttackSwordMasterUnequipped() {
        ...
        testAttackUnequipped(swordMasterTarget, 50, 50 - anima.getPower());
    }

    @Test
    public void testAttackSwordMaster() {
        SwordMaster swordMasterTarget = new SwordMaster(50, 2, field.getCell(0, 2));
        testAttackEquipped(swordMasterTarget, 50, (int) (50 - anima.getPower() * 1.5), sword);
    }
    ...
    public void testAttackArcherUnequipped() {
        ...
        testAttackUnequipped(archerTarget, 50, 50 - anima.getPower());
    }

    @Test
    public void testAttackArcher() {
        Archer archerTarget = new Archer(50, 2, field.getCell(0, 2));
        testAttackEquipped(archerTarget, 50, (int) (50 - anima.getPower() * 1.5), bow);
    ...
    public void testAttackFighterUnequipped() {
        ...
        testAttackUnequipped(fighterTarget, 50, 50 - anima.getPower());
    }

    @Test
    public void testAttackFighter() {
        Fighter fighterTarget = new Fighter(50, 2, field.getCell(0, 2));
        testAttackEquipped(fighterTarget, 50, (int) (50 - 1.5 * anima.getPower()), axe);
    }
    ...
    public void testAttackClericUnequipped() {
        ...
        testAttackUnequipped(clericTarget, 50, 50 - anima.getPower());
    }

    @Test
    public void testAttackCleric() {
        Cleric clericTarget = new Cleric(50, 2, field.getCell(0, 2));
        testAttackEquipped(clericTarget, 50, 50 - anima.getPower(), staff);
    }
    ...
    public void testAttackDarkSorcererUnequipped() {
        ...
        testAttackUnequipped(sorcererTarget, 50, 50 - anima.getPower());
    }
    @Test
    ...
    public void testAttackLightSorcerer() {
        Sorcerer sorcererTarget = new Sorcerer(50, 2, field.getCell(0, 2));
        testAttackEquipped(sorcererTarget, 50, (int) (50 - 1.5 * anima.getPower()), light);
    }
    ...
    public void testAttackAnimaSorcerer() {
        Sorcerer sorcererTarget = new Sorcerer(50, 2, field.getCell(0, 2));
        testAttackEquipped(sorcererTarget, 50, 50 - anima.getPower(), anima);
    }
    ...
    public void testAttackAlpaca() {
        testAttackUnequipped(targetAlpaca, 50, 50 - anima.getPower());
    }
    ...
    public void testCombatHero() {
        ...
        testCombatEquipped(50 - (int) (1.5 * spear.getPower()), heroTarget, 50,
                50 - (int) (1.5 * anima.getPower()), spear);
    }
    ...
    public void testCombatSwordMaster() {
        ...
        testCombatEquipped(50 - (int) (1.5 * sword.getPower()), swordMasterTarget, 50,
                50 - (int) (1.5 * anima.getPower()), sword);
    }
    ...
    public void testCombatAnimaSorcerer() {
        ...
        testCombatEquipped(50 - otherAnima.getPower(), sorcererTarget, 50,
                50 - anima.getPower(), otherAnima);
    }
    ...
    public void testCombatDarkSorcerer() {
        ...
        testCombatEquipped(50 - (int) (1.5 * dark.getPower()), sorcererTarget, 50,
                50 - Math.max(0, anima.getPower() - 20), dark);
    }
    ...
    public void testCombatLightSorcerer() {
        Sorcerer sorcererTarget = new Sorcerer(50, 2, field.getCell(0, 2));
        testCombatEquipped(50 - Math.max(0, light.getPower() - 20), sorcererTarget, 50,
                50 - (int) (1.5 * anima.getPower()), light);
    }
    ...
    @Test
    public void testUseOnAllUnitsAnimaSorcerer() {
        Anima otherAnima = new Anima("Anima", 10, 1, 3);
        testUseOnAllUnits(otherAnima, 50, 50 - otherAnima.getPower());
    }

    @Test
    public void testUseOnLowHPAnimaSorcerer() {
        Anima otherAnima = new Anima("Anima", 50, 1, 3);
        testUseOnLowHPAllUnits(otherAnima);
    }

    @Test
    public void testUseOnOutOfRangeAnimaSorcerer() {
        Anima otherAnima = new Anima("Anima", 50, 1, 3);
        testUseOnOutOfRangeTargetAllUnits(otherAnima);
    }
